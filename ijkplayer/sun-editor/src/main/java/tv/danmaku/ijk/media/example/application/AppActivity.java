...
import editor.activities.EditorActivity;
...
public class AppActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
      ...
      /*      MySimpleTest simpleTest = new MySimpleTest(getApplicationContext());
            simpleTest.markTestArryList();
            ArrayList<String> urlList = simpleTest.getUrlList();
            String url = urlList.get(1);
            MarkMatch markMatch = new MarkMatch();
            MarkSegment seg0 = new MarkSegment(url, 1, 10 * 1000);
            MarkSegment seg1 = new MarkSegment(url, 20 * 1000, 30 * 1000);
            markMatch.addSegment(seg0);
            markMatch.addSegment(seg1);
            markMatch.addSubTitle(new MarkSubTitle("text1", 1, 10000));
            markMatch.addSubTitle(new MarkSubTitle("text2", 20000, 30000));

            EditorActivity.intentTo(this, markMatch);*/
        } else if (id == R.id.action_ep) {
        }
