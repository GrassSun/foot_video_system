...
public class SegmentAdapter extends ArrayAdapter {
    ...
    public SegmentAdapter(Context context, int resource, List objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MarkSegment segment = (MarkSegment) getItem(position);

        if(convertView == null) {
            view = LayoutInflater.from(getContext()).inflate(resourceId, parent, false);
            holder = new ViewHolder();
            holder.text = (TextView) view.findViewById(R.id.segment_info);
            holder.image = (ImageView) view.findViewById(R.id.segment_image);
            view.setTag(holder);
        ...
        holder.text.setText(segment.getName());
